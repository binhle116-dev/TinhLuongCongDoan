...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ("hrm_code", "postman_code", "full_name", "post_office", "contract_type", "is_active")
    search_fields = ("hrm_code", "postman_code", "full_name")
    list_filter = ("post_office", "contract_type", "is_active")
    autocomplete_fields = ("post_office",)
