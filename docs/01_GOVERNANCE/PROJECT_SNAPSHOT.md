...
| Employee Data Status | `159 real employees imported 2026-08-27 (DEC-010) across 7 post offices + 1 management unit (TTVH). 115/159 have postman_code, cross-validated by name against April 2026 reference data (DEC-011) - 7 initially-backfilled codes were found stale and corrected. Recomputing 2026-08-26's single real data file against this roster now resolves 103 employees with a nonzero provisional piece-rate total (sum 22,144,575.05d for that one day). 49 distinct postman codes in real raw data still have no employee match, corresponding mainly to ~15 newly-hired employees (HRM 0027xx/0028xx) not present in any historical file available - needs current route assignment from operations, visible via /bao-cao/chua-anh-xa/.` |
